...
class PokemonRepositotyImpl(val pokemonService: PokemonService) : PokemonRepository {
    ...
    override fun getPokemons(
        ...
        pokemonService.getPokemons(sort, size).enqueue(object : Callback<PokemonResponse> {
    ...
    override fun checkHealth(onComplete: () -> Unit, 
                             onError: (t: Throwable) -> Unit) {
